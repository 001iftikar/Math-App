...
import com.iftikar.mathapp.utils.pad
...
class StudySessionTimerService : Service() {
    ...
    var subjectId = mutableStateOf<Int?>(null) // to prevent losing the selected subject when the app is closed
    ...
    private fun stopForegroundService() {
        notificationManager.cancel(ServiceConstants.NOTIFICATION_ID)
    ...
    private fun startTimer(
        ...
        timer = fixedRateTimer(initialDelay = 1_000L, period = 1_000L) {
